...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        while (num_images >= 0):
            ...
            # NR addition
            # for i, cls in enumerate(pascal_classes):  # pascal_classes contains class names
            #     if cls != '__background__':
            #         # Get the probabilities for the current class (excluding the background)
            #         cls_probs = cls_prob[:, i]
            #         print(f"Probabilities for class '{cls}':", cls_probs)
            # print(type(contact_indices))
            # contact_indices_np = contact_indices.cpu().detach().numpy()
            # NR addition END
            ...
            for j in range(1, len(pascal_classes)):
                ...
                if inds.numel() > 0:
                    ...
                    contact_label_map = {0: 'N', 1: 'S', 2: 'O', 3: 'P', 4: 'F'}  # Update this map based on your actual mapping
